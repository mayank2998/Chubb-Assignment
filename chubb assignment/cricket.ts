...
class scoreBoard{
    ...
    constructor(num : number){
        ...
        this.button.addEventListener("click",function(){
            ...
            if(cellNumber%6 == 1){
                ...
                if(totalcellcountvalue%10 == 0){
                   ...
                   var element = <HTMLInputElement> document.getElementById("hit"+totalcellcountvalue/10);
        ...
        let game = document.getElementById("scoreboard")
...
class ScoreSheet2{
    ...
    scoreSheetContainer : HTMLElement;
...
class matchResult{
    ...
    mom : HTMLElement;
    momPlayers : HTMLElement;
    momTeams : HTMLElement;
    momScores : HTMLElement;
